...
* Supports scrobbling from many [**Sources**](https://docs.multi-scrobbler.app/configuration/sources)
    ...
    * [Subsonic-compatible APIs](https://docs.multi-scrobbler.app/configuration/sources/subsonic) (like [Navidrome](https://www.navidrome.org/) and [Gonic](https://github.com/sentriz/gonic))
