import { type PlayPlatformId } from "../backend/common/infrastructure/Atomic.js";
import { type AmbPlayObject, type DateLike, type PlayObject, type PlayObjectMinimal } from "./Atomic.js";
