...
import { type ConfigMeta, type ConfigureAs, type ConfigureAsSource, type InternalConfig, type InternalConfigOptional } from "../common/infrastructure/Atomic.js";
...
import { type AIOConfig, type SourceDefaults } from "../common/infrastructure/config/aioConfig.js";
import { type AzuracastData, type AzuracastSourceConfig } from "../common/infrastructure/config/source/azuracast.js";
import { type ChromecastData, type ChromecastSourceConfig } from "../common/infrastructure/config/source/chromecast.js";
import { type DeezerData, type DeezerSourceConfig, type DeezerInternalSourceConfig, type DeezerCompatConfig, type DeezerInternalData } from "../common/infrastructure/config/source/deezer.js";
import { type ListenbrainzEndpointSourceConfig, type ListenbrainzEndpointData } from "../common/infrastructure/config/source/endpointlz.js";
import { type LastFMEndpointSourceConfig, type LastFMEndpointData } from "../common/infrastructure/config/source/endpointlfm.js";
import {
    type JellyApiData,
    type JellyApiSourceConfig,
} from "../common/infrastructure/config/source/jellyfin.js";
import { type JRiverData, type JRiverSourceConfig } from "../common/infrastructure/config/source/jriver.js";
import { type KodiData, type KodiSourceConfig } from "../common/infrastructure/config/source/kodi.js";
import { type LastfmSourceConfig } from "../common/infrastructure/config/source/lastfm.js";
import { type ListenBrainzSourceConfig } from "../common/infrastructure/config/source/listenbrainz.js";
import { type MopidySourceConfig } from "../common/infrastructure/config/source/mopidy.js";
import { type MusicCastData, type MusicCastSourceConfig } from "../common/infrastructure/config/source/musiccast.js";
import { type IcecastData, type IcecastSourceConfig, type IcecastSourceOptions } from "../common/infrastructure/config/source/icecast.js";
import { type MPDData, type MPDSourceConfig } from "../common/infrastructure/config/source/mpd.js";
import { type MPRISData, type MPRISSourceConfig } from "../common/infrastructure/config/source/mpris.js";
import { type MusikcubeData, type MusikcubeSourceConfig } from "../common/infrastructure/config/source/musikcube.js";
import { type PlexApiData, type PlexApiSourceConfig } from "../common/infrastructure/config/source/plex.js";
import { type MalojaSourceConfig } from "../common/infrastructure/config/source/maloja.js";
import { type SourceAIOConfig, type SourceConfig } from "../common/infrastructure/config/source/sources.js";
import { type SpotifySourceConfig, type SpotifySourceData } from "../common/infrastructure/config/source/spotify.js";
import { type SubsonicData, type SubSonicSourceConfig } from "../common/infrastructure/config/source/subsonic.js";
import { type VLCData, type VLCSourceConfig } from "../common/infrastructure/config/source/vlc.js";
import { type WebScrobblerData, type WebScrobblerSourceConfig } from "../common/infrastructure/config/source/webscrobbler.js";
import { type YTMusicData, type YTMusicSourceConfig } from "../common/infrastructure/config/source/ytmusic.js";
import { type YandexMusicBridgeData, type YandexMusicBridgeSourceConfig } from "../common/infrastructure/config/source/ymbridge.js";
import { type SonosData, type SonosSourceConfig } from "../common/infrastructure/config/source/sonos.js";
...
import { type CommonSourceOptions } from '../common/infrastructure/config/source/index.js';
import { type ExternalMetadataTerm, type PlayTransformHooks, type PlayTransformOptions } from '../common/infrastructure/Transform.js';
...
import { type MalojaData } from '../common/infrastructure/config/client/maloja.js';
import { type LibrefmData } from '../common/infrastructure/config/client/librefm.js';
import { type ListenBrainzData } from '../common/infrastructure/config/client/listenbrainz.js';
import { type KoitoData } from '../common/infrastructure/config/client/koito.js';
import { type TealData } from '../common/infrastructure/config/client/tealfm.js';
import { type RockSkyData } from '../common/infrastructure/config/client/rocksky.js';
