...
export class NavidromeSource extends MemorySource {
    ...
    getRecentlyPlayed = async (options: RecentlyPlayedOptions = {}) => {
        ...
        const deduped = removeDuplicates(entry.map(x => NavidromeSource.formatPlayObj(x, {sourceData: this.sourceData})));
