import { type AzuracastSourceAIOConfig, type AzuracastSourceConfig } from "./azuracast.js";
import { type ChromecastSourceAIOConfig, type ChromecastSourceConfig } from "./chromecast.js";
import { type ListenbrainzEndpointSourceAIOConfig, type ListenbrainzEndpointSourceConfig } from "./endpointlz.js";
import { type LastFMEndpointSourceAIOConfig, type LastFMEndpointSourceConfig } from "./endpointlfm.js";
import { type DeezerInternalSourceConfig, type DeezerInternalAIOConfig, type DeezerSourceAIOConfig, type DeezerSourceConfig, type DeezerCompatConfig, type DeezerAIOCompatConfig } from "./deezer.js";
import { type JellyApiSourceAIOConfig, type JellyApiSourceConfig } from "./jellyfin.js";
import { type JRiverSourceAIOConfig, type JRiverSourceConfig } from "./jriver.js";
import { type KodiSourceAIOConfig, type KodiSourceConfig } from "./kodi.js";
import { type LastFmSouceAIOConfig, type LastfmSourceConfig } from "./lastfm.js";
import { type ListenBrainzSourceAIOConfig, type ListenBrainzSourceConfig } from "./listenbrainz.js";
import { type MopidySourceAIOConfig, type MopidySourceConfig } from "./mopidy.js";
import { type MPDSourceAIOConfig, type MPDSourceConfig } from "./mpd.js";
import { type MPRISSourceAIOConfig, type MPRISSourceConfig } from "./mpris.js";
import { type MusikcubeSourceAIOConfig, type MusikcubeSourceConfig } from "./musikcube.js";
import { type MusicCastSourceConfig, type MusicCastSourceAIOConfig } from "./musiccast.js";
import { type PlexApiSourceConfig, type PlexApiSourceAIOConfig } from "./plex.js";
import { type SpotifySourceAIOConfig, type SpotifySourceConfig } from "./spotify.js";
import { type SubsonicSourceAIOConfig, type SubSonicSourceConfig } from "./subsonic.js";
import { type VLCSourceAIOConfig, type VLCSourceConfig } from "./vlc.js";
import { type WebScrobblerSourceAIOConfig, type WebScrobblerSourceConfig } from "./webscrobbler.js";
import { type YTMusicSourceAIOConfig, type YTMusicSourceConfig } from "./ytmusic.js";
import { type YandexMusicBridgeSourceAIOConfig, type YandexMusicBridgeSourceConfig } from "./ymbridge.js";
import { type IcecastSourceAIOConfig, type IcecastSourceConfig } from "./icecast.js";
import { type KoitoSourceAIOConfig, type KoitoSourceConfig } from "./koito.js";
import { type MalojaSourceAIOConfig, type MalojaSourceConfig } from "./maloja.js";
import { type TealSourceAIOConfig, type TealSourceConfig } from "./tealfm.js";
import { type RockskySourceAIOConfig, type RockskySourceConfig } from "./rocksky.js";
import { type LibrefmSouceAIOConfig, type LibrefmSourceConfig } from "./librefm.js";
import { type SonosSourceAIOConfig, type SonosSourceConfig } from "./sonos.js";
