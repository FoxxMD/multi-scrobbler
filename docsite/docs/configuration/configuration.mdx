...
<Tabs groupId="configType" queryString>
    ...
    <TabItem value="file" label="File">
        ...
        * Docker -> `/config` (in the container) -- see the [install docs](../installation/installation.md#docker) for how to configure this correctly
        ...
        For docker installations these examples are copied to your configuration directory on first-time use. There is also a [**kitchensink example**](kitchensink.md) that provides examples of using all sources/clients in a complex configuration.
    ...
    <TabItem value="aio" label="File AIO">
        ...
        * Docker -> `/config/config.json` (in the container) -- see the [install docs](../installation/installation.md#docker) for how to configure this correctly
