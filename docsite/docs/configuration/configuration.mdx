...
<Tabs groupId="configType" queryString>
    <TabItem value="env" label="ENV">
        ...
        This method means MS **does not require config files** but it will still create and use data files in the [local](/installation/#persistent-directories) or [docker](/installation/?dockerSetting=storage#recommended-settings) data directory.
    ...
    <TabItem value="file" label="File">
        ...
        * Local installation -> See [Persistent Directories](/installation/#persistent-directories)
...
If you want to run Multi-Scrobbler on a domain's subpath instead of the root, IE `https://mydomain.com/multi-scrobbler`, you **must** set Base URL **as an ENV**.

See the **Base URL** tab in [docker installation Recommended Settings](../installation/?dockerSetting=baseUrl#recommended-settings) for more details.
