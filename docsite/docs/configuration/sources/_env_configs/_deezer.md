...
| ---------------------- | ------- | -------------------------------------------------------------------- | -------------------------------------------------- |
| **`DEEZER_ID`**        | string  |                                                                      | A globally unique ID                               |
| `DEEZER_NAME`          | string  | Value of `DEEZER_ID`                                                 | A vanity name                                      |
| `DEEZER_ENABLE`        | boolean |                                                                      |                                                    |
| **`DEEZER_ARL`**       | string  |                                                                      | ARL retrieved from Deezer response header          |
