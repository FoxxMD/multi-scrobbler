...
Multi-scrobbler cannot automatically determine if you are listening to a Station. Therefore, **automatic monitoring for Icecast Sources is off by default.**

Use [**Monitoring Activity and Default Monitoring**](/configuration/sources#default-monitoring-and-activity-detection) to initiate scrobbling or configure automatic scrobble.
