...
When [`autoMonitor`](/configuration/sources#default-monitoring-and-activity-detection) is not explicitly set, Multi-scrobbler will set the **default monitoring behavior** based on if either of these settings is configured:
