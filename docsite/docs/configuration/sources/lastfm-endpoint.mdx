...
See: API Documentation for [**Lastfm Ingress (Standard)**](/api/accept-a-last-fm-scrobble-standard/)
...
See: API Documentation for [**Lastfm Ingress (Slug)**](/api/accept-a-last-fm-scrobble-slug/)
