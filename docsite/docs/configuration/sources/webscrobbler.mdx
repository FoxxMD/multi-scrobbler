...
The webscrobbler API endpoint for Multi-Scrobbler is documented [**here**](/api/accepts-a-webscrobbler-native-scrobble/).
...
<details>
    ...
    * To use `bUserWS` source set **API URL** to `http://localhost:9078/api/webscrobbler/userb`
    ...
    See: [**Webscrobbler API Docs**](/api/accepts-a-webscrobbler-native-scrobble/)
