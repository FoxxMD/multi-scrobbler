...
* `/*callback*` - wildcard route, used for completing authentication flows for [Spotify](/configuration/sources/spotify), [Last.fm](/configuration/client/lastfm), and [Libre.fm](/configuration/clients/librefm)
