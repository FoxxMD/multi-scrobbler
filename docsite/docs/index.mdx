...
* Supports monitoring activity from many [**Sources**](/configuration/sources)
    ...
    * [ListenBrainz (Endpoint)](/configuration/sources/listenbrainz-endpoint) (Home Assistant, Navidrome, TIDAL Hi-Fi)
    * [Maloja](/configuration/sources/maloja)
    * [Mixcloud](/configuration/sources/mixcloud)
    ...
    * [Subsonic-compatible APIs](/configuration/sources/subsonic) (like [Navidrome](https://www.navidrome.org/) and [Gonic](https://github.com/sentriz/gonic))
