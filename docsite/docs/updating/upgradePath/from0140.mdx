...
In `0.14.0` [Cache](/configuration/cache) has been simplified with much of the required configuration being removed.
...
If you do not have any of the above [Cache](/configuration/cache) configuration defined then you can **skip this step.** 
